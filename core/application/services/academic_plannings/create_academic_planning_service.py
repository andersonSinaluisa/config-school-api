...
class CreateAcademicPlanningService:
    def __init__(
        self,
    ...
    def execute(
        ...
        if self.academic_planning_repository.exist_by_parallel_subject_date(parallel_id, subject_id, start_date):
        ...
        return self.academic_planning_repository.create(planning)
